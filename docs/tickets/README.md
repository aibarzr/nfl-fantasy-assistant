...
| 5 — Live platform loops | 10 | 5 | In progress — ESPN initialization is blocked on identity, semantic-codebook, and recovery evidence; Sleeper discovery is complete and its adapter remains gated on versioned identity mapping |
| **Total** | **38** | **33** | |
