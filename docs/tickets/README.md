...
| 5 — ESPN live loop | 8 | 2 | In progress — exact surface/security and service-worker transport are complete; trusted initialization is blocked on user-identity, semantic-codebook, and recovery evidence |
| **Total** | **36** | **30** | |
